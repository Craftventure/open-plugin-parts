...
//    @Deprecated
//    public static float getPitch(NbsFile.NoteBlock note){
...
//    }
     ...
     * @return pitch
     */
    public static float getPitchInOctave(NbsFile.NoteBlock note) {
     ...
     * @return pitch
     */
    public static float getPitchTransposed(NbsFile.NoteBlock note) {
