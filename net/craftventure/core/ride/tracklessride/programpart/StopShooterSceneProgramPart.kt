...
class StopShooterSceneProgramPart(
    private val data: Data,
    scene: TracklessRideScene,
) : ProgramPart<Any>(scene) {
    override val type: String = StopShooterSceneProgramPart.type
    ...
    override fun execute(
        ...
        if (data.forGroup)
            ...
            ride.shooterRideContext?.stopScene(data.id)
    ...
    data class Data(
        ...
        override fun toPart(scene: TracklessRideScene): ProgramPart<Any> = StopShooterSceneProgramPart(this, scene)
    }

    companion object {
        const val type = "stop_shooter_scene"
    }
}