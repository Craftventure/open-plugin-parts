...
public final class VectorUtils {
    ...
    public static Vector copy(Vector from, Vector to) {
        to.setX(from.getX());
        to.setY(from.getY());
        to.setZ(from.getZ());
        return to;
    ...
    public static final Vector rotateVector(Vector v, double angleX, double angleY, double angleZ) {
        ...
        // Having some strange behavior up there.. Have to look in it later. ODO
    ...
    /**
     * This handles non-unit vectors, with yawRadian and pitchRadian instead of X,Y,Z angles.
     * <p>
     * Thanks to SexyToad!
     *
     * @param v
